...
export const SKILLS = [
  { id: 'skill_xp_boost_1', title: 'XP +10%', desc: 'Ganas 10% más XP (timer + tareas).', cost: 1, reqLevel: 2, parents: [] },
  { id: 'skill_multiplier_cap', title: 'Combo estable', desc: '+1 tier máximo de racha (más multiplicador).', cost: 1, reqLevel: 4, parents: ['skill_xp_boost_1'] },
  { id: 'skill_review_bonus', title: 'Memoria reforzada', desc: '+25% XP por repasos espaciados.', cost: 1, reqLevel: 3, parents: ['skill_xp_boost_1'] },
  { id: 'skill_xp_boost_2', title: 'XP +20%', desc: 'Ganas 20% más XP (timer + tareas).', cost: 2, reqLevel: 5, parents: ['skill_xp_boost_1'] },
  { id: 'skill_topic_bonus', title: 'Impulso de tema', desc: '+5 XP al completar un tema.', cost: 2, reqLevel: 6, parents: ['skill_xp_boost_1'] },
  { id: 'skill_review_master', title: 'Repaso constante', desc: '+5 XP extra cuando un repaso está "a tiempo".', cost: 2, reqLevel: 7, parents: ['skill_review_bonus'] }
];
